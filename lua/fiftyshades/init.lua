...
M.base_syntax = function()
	...
	hi(class_debug, { fg = palette.colors.bg, bg = palette.colors.lime_green })
	...
	hi("Error", { fg = palette.colors.fg, bg = palette.colors.none })
	...
	hi("Todo", { fg = background, bg = palette.colors.lime_green })
...
M.ui = function()
	...
	hi("ErrorMsg", { fg = palette.colors.fg, bg = palette.colors.none })
	...
	hs("DiagnosticUnderlineError", { fg = palette.colors.grey_20, bg = palette.colors.none }, underline)
